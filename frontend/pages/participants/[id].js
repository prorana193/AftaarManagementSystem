  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard
          title="Total Expense"
          value={formatCurrency(profile.totalExpense)}
          color="warning"
        />
        <StatCard
          title="Remaining Balance"
          value={formatCurrency(profile.remainingBalance)}
          color={profile.remainingBalance >= 0 ? 'success' : 'error'}
        />
        <StatCard
          title="Aftaar Participations"
          value={profile.totalAftaarParticipations}
          color="info"
        />
      </div>
